...
func (key *pkcs11PrivateKeyRSA) Sign(rand io.Reader, digest []byte, opts crypto.SignerOpts) (
...
func (key *pkcs11PrivateKeyECC) Sign(rand io.Reader, digest []byte, opts crypto.SignerOpts) (
	signature []byte, err error) {
